...
sentinelInUseSoEmailNotRequired = Microsoft Sentinel est utilisé pour l'abonnement {0}, les notifications par e-mail pour Defender for Cloud ne sont pas requises.
