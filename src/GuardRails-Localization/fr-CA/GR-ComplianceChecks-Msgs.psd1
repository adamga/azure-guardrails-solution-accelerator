...
wAFNotEnabled = La passerelle d'application attribuée n'a pas de pares-feux d'application Web (WAF) configuré. Activez un WAF sur la passerelle d'application OU vérifiez que des mesures d'atténuation sont en place au niveau de la couche d'application.
